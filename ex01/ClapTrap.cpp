...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/20 11:20:42 by ayassin           #+#    #+#             */
/*   Updated: 2022/10/20 11:20:43 by ayassin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void): hp(100), eng(10), dmg(0)
{
	name = "WarpTart";
	std::cout<< "Default constructor called\n";
}

ClapTrap::ClapTrap(std::string pname): hp(100), eng(10), dmg(0)
{
	name = pname;
